        ...
        <div className="relative">
            ...
            {isExpanded && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="relative bg-white bg-opacity-100 rounded-lg p-4 flex flex-col items-center space-y-4"
                         style={{ transform: 'translateY(400px)', borderWidth: '15px', borderColor: 'white', borderRadius: '1rem' }}>
                        ...
                        <div className="flex space-x-2">
                            ...
                            <button onClick={() => shareContent('instagram')} className="p-2 rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-4 w-4 fill-[#c13584]">
                            ...
                            <button onClick={() => shareContent('copy')} className="p-2 rounded">
                                <img src="/images/link-button-svgrepo-com.svg" alt="Copy link" className="h-7 w-7" />
                            </button>
