    ...
    return (
        <>
            <button
                ...
                className="w-8 h-8 bg-cover bg-center fixed top-4 right-4 z-[60]"
                ...
                <div className="fixed inset-0 flex items-center justify-center z-[60]">
                    ...
                    <div className="relative bg-white rounded-lg p-8 flex flex-col items-center space-y-8 z-[70] max-w-md w-full mx-4"
                        ...
                        <div className="flex gap-6">
                            ...
                            <button onClick={() => shareContent('copy')} className="p-3 rounded hover:bg-gray-100">
                                <img src="/images/link-button-svgrepo-com.svg" alt="Copy link" className="h-8 w-8" />
                            </button>
