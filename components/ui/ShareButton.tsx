    ...
    <>
      ...
      {isExpanded && (
        <div className="fixed inset-0 flex items-center justify-center z-[60]">
          ...
          <div
            className="relative bg-white rounded-lg p-8 flex flex-col items-center space-y-8 z-[70] max-w-md w-full mx-4"
            style={{
              borderWidth: "15px",
              borderColor: "white",
              borderRadius: "1rem",
          ...
          >
            ...
            <p className="text-center text-xl font-semibold">
              Share the Toy Fair with the World!
            </p>
            <div className="flex gap-6">
              ...
              <button
                ...
                className="p-3 w-16 rounded hover:bg-gray-100"
              >
                <Image
